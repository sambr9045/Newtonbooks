			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 col-sm-6 col-6 col-lg-2">
						<div class="logo">
							<a href="index">
								<img src="assets/images/logo/logo.png" alt="logo images" width="110px" height="40px">
							</a>
						</div>
					</div>
											...
											<div class="switcher-options">
												<div class="switcher-currency-trigger">
													<div class="setting__menu">
														...
														<span><a href="account/saved-items">My Wishlist</a></span>
														<span><a href="account/orders">my orders</a></span>
														<span><a href="account/index?logout">Logout</a></span>
													</div>
												</div>
											</div>
										</div>
